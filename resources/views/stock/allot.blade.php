...
@section('title', 'Allot Stock')

@section('content')
<div class="row justify-content-center">
    <div class="col-md-6">
        <h4>Allot Stock Temporarily</h4>
        <form method="POST" action="{{ url('/stock/allot') }}">
            @csrf
            ...
            <div class="mb-3">
                <label class="form-label">Amount to Allot</label>
            ...
            <button class="btn btn-warning text-dark">Allot Stock</button>
        </form>
    </div>
</div>
